        ...
        try:
            self.slurmrestd = SlurmrestdFilteredCached(
                ...
                SlurmrestdAuthentifier(
                    ...
                    pcs_secret_id=getattr(self.settings.slurmrestd, "pcs_secret_id", None),
                    pcs_region=getattr(self.settings.slurmrestd, "pcs_region", None),
                    pcs_uid=getattr(self.settings.slurmrestd, "pcs_uid", 0),
                    pcs_gid=getattr(self.settings.slurmrestd, "pcs_gid", 0),
                    pcs_gids=getattr(self.settings.slurmrestd, "pcs_gids", None),
                    pcs_gecos=getattr(self.settings.slurmrestd, "pcs_gecos", "Slurm Web Agent"),
                    pcs_home_dir=getattr(self.settings.slurmrestd, "pcs_home_dir", "/"),
                    pcs_shell=getattr(self.settings.slurmrestd, "pcs_shell", "/sbin/nologin"),
                ),
